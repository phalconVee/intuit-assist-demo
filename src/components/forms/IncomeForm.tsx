  ...
  return (
    <div className="max-w-6xl mx-auto p-4 lg:p-8">
      <div className="bg-white rounded-xl shadow-lg border border-gray-200">
        {/* Header */}
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 lg:p-6 border-b border-gray-200 rounded-t-xl">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl lg:text-2xl font-bold text-gray-900">Income & Expenses</h2>
                <p className="text-sm lg:text-base text-gray-600">Report all sources of income for the tax year</p>
              </div>
            </div>
          ...
          <nav className="flex space-x-4 lg:space-x-8 px-4 lg:px-6 min-w-max">
            {tabs.map((tab) => (
              <button
                ...
                className={`py-3 lg:py-4 px-2 border-b-2 font-medium text-sm transition-colors flex items-center space-x-2 whitespace-nowrap ${
                  activeTab === tab.id
